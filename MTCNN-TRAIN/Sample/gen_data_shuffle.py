...
if(lmdb_id == 0):
    lmdb_env_12 = lmdb.open('mtcnn_train_12', map_size=1000000000)
    lmdb_txn_12 = lmdb_env_12.begin(write=True)
elif(lmdb_id == 1):
    lmdb_env_24 = lmdb.open('mtcnn_train_24', map_size=5000000000)
    lmdb_txn_24 = lmdb_env_24.begin(write=True)
else:
    lmdb_env_48 = lmdb.open('mtcnn_train_48', map_size=10000000000)
